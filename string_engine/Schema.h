...
public:
    ...
    std::string getVariableIdentifier() { return _variableIdentifier; };
    std::string getDeclaration() { return getDataType() + " " + getVariableIdentifier() + ";"; }
...
public:
    ...
    std::string getDataType() override { return "std::vector<" + _valueType->getDataType() + ">"; }
...
public:
    ...
    std::string getDataType() override { return "std::deque<" + _valueType->getDataType() + ">"; }
...
public:
    ...
    std::string getDataType() override { return "std::unordered_map<" + _keyType->getDataType() + "," + _valueType->getDataType() + ">"; }
...
public:
    ...
    std::string getDataType() override {
        ...
        for (auto& tupleElement : _tupleElements)
            typeString += tupleElement->getDataType() + ",";
        typeString.pop_back();
        typeString += ">";
        return typeString;
    }
...
public:
    ...
    std::string getDataType() override { return _dataType; }
...
public:
    ...
    std::string getAccessor(std::shared_ptr<_Datatype> variableToFind) {
        ...
        if (result != _variables.end())
            return (*result)->getVariableIdentifier();

        for (auto variable : _variables) {
            if (variable->contains(variableToFind))
                return fmt::format(variable->getAccessor(variableToFind), variable->getVariableIdentifier());
        }
...
public:
    ...
    explicit _AggregationSchema(std::vector<std::pair<std::shared_ptr<_Datatype>, AggregationType>> variables)
